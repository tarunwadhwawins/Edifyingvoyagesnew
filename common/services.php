<div class="row">
    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
            <span class="icon-outer d-block mb-4">
                <img src="assets/svg-icons/social-media-marketing.svg" alt="image" class="icon-image" />
            </span>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
            <span class="icon-outer d-block mb-4">
                <img src="assets/svg-icons/e-commerce.svg" alt="image" class="icon-image" />
            </span>
            <h5>eCommerce SEO</h5>
            <p class="mb-0">Progressively empower business "outside the box" thinking with resource-leveling
                partnerships.</p>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
            <span class="icon-outer d-block mb-4">
                <img src="assets/svg-icons/website-management.svg" alt="image" class="icon-image" />
            </span>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
            <span class="icon-outer d-block mb-4">
                <img src="assets/svg-icons/designing.svg" alt="image" class="icon-image" />
            </span>
