            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-7">
                    <div class="page-header-content text-center pt-sm-5 pt-md-5 pt-lg-0">
                        <h1 class="color-white mb-0">Service Details</h1>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <div class="service-details-wrap">
                        <img src="assets/images/slider-img-2.jpg" alt="services" class="img-fluid rounded shadow-sm" />
                        <div class="services-detail-content mt-4">
                            ...
                            <div class="row mt-5">
                                <div class="col-md-6">
                                    <div class="img-wrap">
                                        <img src="assets/images/images.jpg" alt="services" class="img-fluid" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <ul class="list-unstyled tech-feature-list">
                                        ...
                                        <li class="py-1"><span class="ti-check-box me-2 color-secondary"></span><strong>Foreclosure</strong>
                                            consultant Human consulting
                                        </li>
                                        <li class="py-1"><span class="ti-check-box me-2 color-secondary"></span><strong>Corporate</strong>
                                            Immigration, Information
                                        </li>
                                        <li class="py-1"><span class="ti-check-box me-2 color-secondary"></span><strong>SEO</strong> Optimization consultant</li>
                                        <li class="py-1"><span class="ti-check-box me-2 color-secondary"></span><strong>Rapidiously</strong> conceptualize communities</li>
                                        <li class="py-1"><span class="ti-check-box me-2 color-secondary"></span><strong>Consultant</strong>
                                            pharmacist Creative consultant
                                        </li>
                                        <li class="py-1"><span class="ti-check-box me-2 color-secondary"></span><strong>Monotonectally</strong>
                    ...
                    <div class="sidebar-right pl-4">
                        ...
                        <aside class="widget widget-categories">
                            ...
                            <ul class="primary-list mt-25">
                                <li><span class="ti-location-pin me-2 color-primary"></span> 123 Yellow House, Mn 9007
                                </li>
                                <li><span class="ti-mobile me-2 color-primary"></span> (+123) 456-789-012</li>
                                <li><span class="ti-email me-2 color-primary"></span> youname@domail.com</li>
                            </ul>
                        </aside>
                        <aside class="widget widget-categories">
                            <div class="widget-title">
