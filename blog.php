...
<div class="main pt-70">
    <!---->
    <section class="about-section ptb-100" style="background: url('assets/images/blog-banner.webp')no-repeat center center / cover">
                        ...
                        <div class="card-body">
                            <div class="post-meta mb-2">
                                <ul class="list-inline meta-list">
                                    <li class="list-inline-item"><i class="fas fa-heart me-2"></i><span>45</span>
                                        Comments
                                    </li>
                                    <li class="list-inline-item"><i class="fas fa-share-alt me-2"></i><span>10</span>
                                        Share
                                    </li>
                                </ul>
                            </div>
                            ...
                            <p class="card-text">Some quick example text to build on the card title and make up the
                                bulk.</p>
                            <a href="blog-details" class="detail-link">Read more <span class="ti-arrow-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
